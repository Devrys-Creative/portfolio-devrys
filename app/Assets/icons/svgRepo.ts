...
import logoCpp from "./svg-repo/cpp.svg";
import logoJS from "./svg-repo/js.svg";
import logoVet from "./svg-repo/vet.svg";
import logoTS from "./svg-repo/ts.svg";
import logoOC from "./svg-repo/OC.svg";
import logoReact from "./svg-repo/react.svg";
import logoRedux from "./svg-repo/redux.svg";
import logoNext from "./svg-repo/next-js.svg";
import logoVue from "./svg-repo/vue.svg";
import logoNuxt from "./svg-repo/nuxt.svg";
import logoAngular from "./svg-repo/angular.svg";
import logoSf from "./svg-repo/symfony.svg";
import logoGit from "./svg-repo/git.svg";
